...
import { adminPage, btnPrimary, surfaceCard } from "@/lib/ui-classes";
    ...
    <div className={cn(adminPage, "gap-3")}>
      <header className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/admin/operaciones/circuitos/nuevo" className={cn(btnPrimary, "px-3 py-1.5 text-xs")}>
            + Nuevo
          </Link>
        </div>
      </header>
      ...
      {circuits.length === 0 ? (
        <div className="rounded-xl border border-dashed border-border bg-muted/50 px-6 py-10 text-center">
          ...
          <Link href="/admin/operaciones/circuitos/nuevo" className="mt-2 inline-block text-xs font-semibold text-led underline">
