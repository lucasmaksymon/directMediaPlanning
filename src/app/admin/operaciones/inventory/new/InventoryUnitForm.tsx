...
function FormSection({
  ...
  return (
    <section className={cn(surfaceCard(), "p-5 sm:p-6", className)}>
...
type ProviderOption = { id: string; companyName: string };
...
export function InventoryUnitForm({
  ...
  return (
    <form action={action} className="flex h-full min-h-0 w-full flex-col gap-4">
      ...
      <FormSection className="xl:col-span-2" optional title="Fotos del espacio" description="Subí hasta 6 imágenes del cartel o pantalla. Aparecen en la ficha del catálogo público.">
